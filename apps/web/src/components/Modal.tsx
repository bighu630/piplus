...
export default function Modal({
  ...
  return (
    ...
    >
      <div 
        className={`bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl w-full ${maxWidthClassName} p-6 shadow-xl space-y-4 flex flex-col h-[72vh] overflow-hidden`}
